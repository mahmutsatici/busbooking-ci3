                    ...
                    <div class="row"> 
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo strtoupper($sefer['KalkisYeri']); ?></td>
                                    <td><?php echo strtoupper($sefer['VarisYeri']); ?></td>
                                    <td><?php echo date("d/m/Y", strtotime($sefer['Tarih'])); ?></td>
                                    <td><?php echo $sefer['KalkisSaati'] . ".00"; ?></td>
                                    <td><?php echo $sefer['VarisSaati'] . ".00"; ?></td>
                                    <td><?php echo $sefer['Fiyat'] . " TL"; ?></td>
                                    <td><a href="<?php echo base_url('home/bilet/'.$sefer['SeferID']) ?>"
                                            class="btn btn-primary">Bilet Al</a></td>
                                </tr>
                                <?php } } else {
                                                echo "<h2><center> Sefer bulunamadı </center></h2>";
                                            } ?>
                            </tbody>
                        </table>
                    </div>
